  ...
  return (
    <div className="mx-64 mt-7">
      ...
      <div className="bg-[#2d2159] rounded-md flex flex-row justify-between pl-10 pr-32 mt-5 items-center">
        <div className="text-white text-4xl py-5">800</div>
      ...
      <div className="flex flex-row gap-10 mt-10 justify-center items-center">
        ...
        <div className="flex flex-col justify-center items-center">
          <div className="flex flex-row items-center gap-10">
            <div className="uppercase text-white text-4xl">total deposit:</div>
            <div className="text-4xl py-5 w-60 text-center bg-[#2d2159] text-white">1000</div>
          </div>
          <div className="bg-gradient-to-r from-purple-500 to-pink-500 w-full h-3 my-4" />
          <div className="flex flex-row items-center gap-10">
            <div className="uppercase text-white text-4xl">total earned:</div>
            <div className="text-4xl py-5 w-60 text-center bg-[#2d2159] text-white">2800</div>
          </div>
        </div>
      </div>
    </div>
